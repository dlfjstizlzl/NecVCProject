...
fun CustomButton(
    ...
    Button(
        ...
        colors = if (isEnable) ButtonDefaults.buttonColors(containerColor = colors) else ButtonDefaults.buttonColors(
            containerColor = LocalColorPalette.current.primary.secondary
        ),
